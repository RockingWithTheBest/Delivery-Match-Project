...
namespace Backend.TrainingData
{
    public class RouteData : IEntityTypeConfiguration<Route>
    {
        public void Configure(EntityTypeBuilder<Route> builder)
        {
            builder.HasData
            (
                new Route { Id = 1, Route_Data = "Route 1 Data", Total_Distance = "15.2 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 30, 0), DriverId = 1, OrderPlacementId = 1 },
                new Route { Id = 2, Route_Data = "Route 2 Data", Total_Distance = "22.8 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 15, 0), DriverId = 2, OrderPlacementId = 2 },
                new Route { Id = 3, Route_Data = "Route 3 Data", Total_Distance = "18.5 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 45, 0), DriverId = 3, OrderPlacementId = 3 },
                new Route { Id = 4, Route_Data = "Route 4 Data", Total_Distance = "27.3 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 30, 0), DriverId = 4, OrderPlacementId = 4 },
                new Route { Id = 5, Route_Data = "Route 5 Data", Total_Distance = "12.1 km", Estimated_Duration = new DateTime(2024, 1, 1, 1, 50, 0), DriverId = 5, OrderPlacementId = 5 },
                new Route { Id = 6, Route_Data = "Route 6 Data", Total_Distance = "19.7 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 55, 0), DriverId = 6, OrderPlacementId = 6 },
                new Route { Id = 7, Route_Data = "Route 7 Data", Total_Distance = "24.9 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 20, 0), DriverId = 1, OrderPlacementId = 7 },
                new Route { Id = 8, Route_Data = "Route 8 Data", Total_Distance = "16.4 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 25, 0), DriverId = 2, OrderPlacementId = 8 },
                new Route { Id = 9, Route_Data = "Route 9 Data", Total_Distance = "21.2 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 5, 0), DriverId = 3, OrderPlacementId = 9 },
                new Route { Id = 10, Route_Data = "Route 10 Data", Total_Distance = "14.8 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 15, 0), DriverId = 4, OrderPlacementId = 10 },
                new Route { Id = 11, Route_Data = "Route 11 Data", Total_Distance = "23.6 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 40, 0), DriverId = 5, OrderPlacementId = 11 },
                new Route { Id = 12, Route_Data = "Route 12 Data", Total_Distance = "17.9 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 40, 0), DriverId = 6, OrderPlacementId = 12 },
                new Route { Id = 13, Route_Data = "Route 13 Data", Total_Distance = "26.1 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 35, 0), DriverId = 1, OrderPlacementId = 13 },
                new Route { Id = 14, Route_Data = "Route 14 Data", Total_Distance = "13.5 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 10, 0), DriverId = 2, OrderPlacementId = 14 },
                new Route { Id = 15, Route_Data = "Route 15 Data", Total_Distance = "20.3 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 0, 0), DriverId = 3, OrderPlacementId = 15 },
                new Route { Id = 16, Route_Data = "Route 16 Data", Total_Distance = "25.7 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 45, 0), DriverId = 4, OrderPlacementId = 16 },
                new Route { Id = 17, Route_Data = "Route 17 Data", Total_Distance = "15.9 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 35, 0), DriverId = 5, OrderPlacementId = 17 },
                new Route { Id = 18, Route_Data = "Route 18 Data", Total_Distance = "22.4 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 25, 0), DriverId = 6, OrderPlacementId = 18 },
                new Route { Id = 19, Route_Data = "Route 19 Data", Total_Distance = "18.2 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 50, 0), DriverId = 1, OrderPlacementId = 19 },
                new Route { Id = 20, Route_Data = "Route 20 Data", Total_Distance = "24.3 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 30, 0), DriverId = 2, OrderPlacementId = 20 },
                new Route { Id = 21, Route_Data = "Route 21 Data", Total_Distance = "16.7 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 30, 0), DriverId = 3, OrderPlacementId = 21 },
                new Route { Id = 22, Route_Data = "Route 22 Data", Total_Distance = "21.9 km", Estimated_Duration = new DateTime(2024, 1, 1, 3, 15, 0), DriverId = 4, OrderPlacementId = 22 },
                new Route { Id = 23, Route_Data = "Route 23 Data", Total_Distance = "14.3 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 20, 0), DriverId = 5, OrderPlacementId = 23 },
                new Route { Id = 24, Route_Data = "Route 24 Data", Total_Distance = "19.8 km", Estimated_Duration = new DateTime(2024, 1, 1, 2, 55, 0), DriverId = 6, OrderPlacementId = 24 }
