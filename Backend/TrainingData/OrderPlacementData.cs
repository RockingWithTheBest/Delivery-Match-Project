        ...
        public void Configure(EntityTypeBuilder<Order_Placement> builder)
        {
            ...
            (
                ...
                new Order_Placement { Id = 24, Pick_Up_Address = "200 Fitness St", Delivery_Up_Address = "240 Gym Lane", Pick_Up_Contact = "Mike Brown", Delivery_Contact = "Sarah Blue", Weight = 4.0m, Volume = 2.5m, Description = "Yoga Mats", Status = "Cancelled", Price = 100.00m, Distance = "4 miles", Created_At = "2023-09-04", Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 6 },
                   ...
                   new Order_Placement { Id = 37, Pick_Up_Address = "400 River Rd", Delivery_Up_Address = "470 Sea St", Pick_Up_Contact = "Charlie", Delivery_Contact = "Fiona", Weight = 5.0m, Volume = 1.5m, Description = "Accessories", Status = "Pending", Price = 150.00m, Distance = "10 miles", Created_At = "2023-09-08", Scheduled_At = new DateTime(2023, 9, 9), Completed_On = new DateTime(2023, 9, 10), DriverId = 3 },
                   new Order_Placement { Id = 38, Pick_Up_Address = "400 River Rd", Delivery_Up_Address = "480 Shore St", Pick_Up_Contact = "Charlie", Delivery_Contact = "Gina", Weight = 4.0m, Volume = 2.5m, Description = "Home Goods", Status = "Cancelled", Price = 300.00m, Distance = "8 miles", Created_At = "2023-09-09", Scheduled_At = new DateTime(2023, 9, 10), Completed_On = new DateTime(2023, 9, 11), DriverId = 3 },
                   new Order_Placement { Id = 39, Pick_Up_Address = "400 River Rd", Delivery_Up_Address = "490 Hill St", Pick_Up_Contact = "Charlie", Delivery_Contact = "Hank", Weight = 3.5m, Volume = 1.0m, Description = "Stationery", Status = "Delivered", Price = 80.00m, Distance = "5 miles", Created_At = "2023-09-10", Scheduled_At = new DateTime(2023, 9, 11), Completed_On = new DateTime(2023, 9, 12), DriverId = 3 },

                   // Orders for Driver 4
                   new Order_Placement { Id = 40, Pick_Up_Address = "50 Green St", Delivery_Up_Address = "60 Blue St", Pick_Up_Contact = "Diana", Delivery_Contact = "Ethan", Weight = 2.5m, Volume = 1.2m, Description = "Gadgets", Status = "Delivered", Price = 120.00m, Distance = "3 miles", Created_At = "2023-09-11", Scheduled_At = new DateTime(2023, 9, 12), Completed_On = new DateTime(2023, 9, 13), DriverId = 4 },
                   new Order_Placement { Id = 41, Pick_Up_Address = "50 Green St", Delivery_Up_Address = "70 Yellow St", Pick_Up_Contact = "Diana", Delivery_Contact = "Frank", Weight = 3.0m, Volume = 1.5m, Description = "Electronics", Status = "In Transit", Price = 250.00m, Distance = "4 miles", Created_At = "2023-09-12", Scheduled_At = new DateTime(2023, 9, 13), Completed_On = new DateTime(2023, 9, 14), DriverId = 4 },
                   new Order_Placement { Id = 42, Pick_Up_Address = "50 Green St", Delivery_Up_Address = "80 Pink St", Pick_Up_Contact = "Diana", Delivery_Contact = "Grace", Weight = 5.0m, Volume = 2.0m, Description = "Home Appliances", Status = "Pending", Price = 400.00m, Distance = "6 miles", Created_At = "2023-09-13", Scheduled_At = new DateTime(2023, 9, 14), Completed_On = new DateTime(2023, 9, 15), DriverId = 4 },
                   new Order_Placement { Id = 43, Pick_Up_Address = "50 Green St", Delivery_Up_Address = "90 Gray St", Pick_Up_Contact = "Diana", Delivery_Contact = "Henry", Weight = 1.5m, Volume = 0.5m, Description = "Books", Status = "Cancelled", Price = 50.00m, Distance = "2 miles", Created_At = "2023-09-14", Scheduled_At = new DateTime(2023, 9, 15), Completed_On = new DateTime(2023, 9, 16), DriverId = 4 },
                   new Order_Placement { Id = 44, Pick_Up_Address = "50 Green St", Delivery_Up_Address = "100 Black St", Pick_Up_Contact = "Diana", Delivery_Contact = "Ivy", Weight = 4.0m, Volume = 3.0m, Description = "Clothing", Status = "Delivered", Price = 320.00m, Distance = "7 miles", Created_At = "2023-09-15", Scheduled_At = new DateTime(2023, 9, 16), Completed_On = new DateTime(2023, 9, 17), DriverId = 4 },

                   // Orders for Driver 5
                   new Order_Placement { Id = 45, Pick_Up_Address = "75 Red St", Delivery_Up_Address = "85 Orange St", Pick_Up_Contact = "Ethan", Delivery_Contact = "Jack", Weight = 6.0m, Volume = 3.0m, Description = "Furniture", Status = "Delivered", Price = 600.00m, Distance = "10 miles", Created_At = "2023-09-16", Scheduled_At = new DateTime(2023, 9, 17), Completed_On = new DateTime(2023, 9, 18), DriverId = 5 },
                   new Order_Placement { Id = 46, Pick_Up_Address = "75 Red St", Delivery_Up_Address = "95 Violet St", Pick_Up_Contact = "Ethan", Delivery_Contact = "Liam", Weight = 2.5m, Volume = 1.0m, Description = "Kitchenware", Status = "In Transit", Price = 150.00m, Distance = "5 miles", Created_At = "2023-09-17", Scheduled_At = new DateTime(2023, 9, 18), Completed_On = new DateTime(2023, 9, 19), DriverId = 5 },
                   new Order_Placement
                   {
                       Id = 47,
