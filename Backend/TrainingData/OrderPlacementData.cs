    ...
    public class OrderPlacmentData : IEntityTypeConfiguration<OrderPlacement>
    {
        public void Configure(EntityTypeBuilder<OrderPlacement> builder)
        {
            ...
            (
                ...
                new OrderPlacement {Id = 1, Pick_Up_Address = "123 Main St", Delivery_Up_Address = "456 Elm St", Pick_Up_Contact = "John Doe", Delivery_Contact = "Jane Smith", Description = "Electronics", Status = "Delivered", Price = 300.00m, Created_At = new DateTime(2023, 09, 01), Scheduled_At = new DateTime(2023, 9, 2), Completed_On = new DateTime(2023, 9, 3), CustomerId = 1 },
                new OrderPlacement {Id = 2, Pick_Up_Address = "123 Main St", Delivery_Up_Address = "789 Oak St", Pick_Up_Contact = "John Doe", Delivery_Contact = "Alice Brown", Description = "Computers", Status = "In Transit", Price = 500.00m, Created_At = new DateTime(2023, 09, 02), Scheduled_At = new DateTime(2023, 9, 4), Completed_On = new DateTime(2023, 9, 5), CustomerId = 1 },
                new OrderPlacement {Id = 3, Pick_Up_Address = "123 Main St", Delivery_Up_Address = "101 Pine St", Pick_Up_Contact = "John Doe", Delivery_Contact = "Bob White", Description = "Accessories", Status = "Pending", Price = 150.00m, Created_At = new DateTime(2023, 09, 03), Scheduled_At = new DateTime(2023, 9, 6), Completed_On = new DateTime(2023, 9, 7), CustomerId = 1 },
                new OrderPlacement {Id = 4, Pick_Up_Address = "123 Main St", Delivery_Up_Address = "202 Maple St", Pick_Up_Contact = "John Doe", Delivery_Contact = "Lucy Green", Description = "Furniture", Status = "Cancelled", Price = 600.00m, Created_At = new DateTime(2023, 09, 04), Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 1 },

                // Orders for Customer 2
                new OrderPlacement {Id = 5, Pick_Up_Address = "25 Market St", Delivery_Up_Address = "30 Center St", Pick_Up_Contact = "Alice Green", Delivery_Contact = "Tom Brown", Description = "Fresh Produce", Status = "Delivered", Price = 200.00m, Created_At = new DateTime(2023, 09, 01), Scheduled_At = new DateTime(2023, 9, 2), Completed_On = new DateTime(2023, 9, 3), CustomerId = 2 },
                new OrderPlacement {Id = 6, Pick_Up_Address = "25 Market St", Delivery_Up_Address = "35 Park Ave", Pick_Up_Contact = "Alice Green", Delivery_Contact = "Sarah White", Description = "Dairy Products", Status = "In Transit", Price = 300.00m, Created_At = new DateTime(2023, 09, 02), Scheduled_At = new DateTime(2023, 9, 4), Completed_On = new DateTime(2023, 9, 5), CustomerId = 2 },
                new OrderPlacement {Id = 7, Pick_Up_Address = "25 Market St", Delivery_Up_Address = "40 Broadway", Pick_Up_Contact = "Alice Green", Delivery_Contact = "Daniel Black", Description = "Packaged Goods", Status = "Pending", Price = 250.00m, Created_At = new DateTime(2023, 09, 03), Scheduled_At = new DateTime(2023, 9, 6), Completed_On = new DateTime(2023, 9, 7), CustomerId = 2 },
                new OrderPlacement {Id = 8, Pick_Up_Address = "25 Market St", Delivery_Up_Address = "45 Fifth St", Pick_Up_Contact = "Alice Green", Delivery_Contact = "Emma Red", Description = "Beverages", Status = "Cancelled", Price = 400.00m, Created_At = new DateTime(2023, 09, 04), Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 2 },

                // Orders for Customer 3
                new OrderPlacement {Id = 9, Pick_Up_Address = "45 Fast Food Rd", Delivery_Up_Address = "50 Snack Ave", Pick_Up_Contact = "Alice Johnson", Delivery_Contact = "Jim Doe", Description = "Fast Food Order", Status = "Delivered", Price = 50.00m, Created_At = new DateTime(2023, 09, 01), Scheduled_At = new DateTime(2023, 9, 2), Completed_On = new DateTime(2023, 9, 3), CustomerId = 3 },
                new OrderPlacement {Id = 10, Pick_Up_Address = "45 Fast Food Rd", Delivery_Up_Address = "55 Snack Ave", Pick_Up_Contact = "Alice Johnson", Delivery_Contact = "Kate Brown", Description = "Burger Order", Status = "In Transit", Price = 30.00m, Created_At = new DateTime(2023, 09, 02), Scheduled_At = new DateTime(2023, 9, 4), Completed_On = new DateTime(2023, 9, 5), CustomerId = 3 },
                new OrderPlacement {Id = 11, Pick_Up_Address = "45 Fast Food Rd", Delivery_Up_Address = "60 Snack Ave", Pick_Up_Contact = "Alice Johnson", Delivery_Contact = "Ben White", Description = "Pizza Order", Status = "Pending", Price = 40.00m, Created_At = new DateTime(2023, 09, 03), Scheduled_At = new DateTime(2023, 9, 6), Completed_On = new DateTime(2023, 9, 7), CustomerId = 3 },
                new OrderPlacement {Id = 12, Pick_Up_Address = "45 Fast Food Rd", Delivery_Up_Address = "65 Snack Ave", Pick_Up_Contact = "Alice Johnson", Delivery_Contact = "Beth Green", Description = "Dessert Order", Status = "Cancelled", Price = 20.00m, Created_At = new DateTime(2023, 09, 04), Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 3 },

                // Orders for Customer 4
                new OrderPlacement {Id = 13, Pick_Up_Address = "100 Book St", Delivery_Up_Address = "110 Library Lane", Pick_Up_Contact = "John Smith", Delivery_Contact = "Alice Johnson", Description = "Books", Status = "Delivered", Price = 25.00m, Created_At = new DateTime(2023, 09, 01), Scheduled_At = new DateTime(2023, 9, 2), Completed_On = new DateTime(2023, 9, 3), CustomerId = 4 },
                new OrderPlacement {Id = 14, Pick_Up_Address = "100 Book St", Delivery_Up_Address = "120 Library Lane", Pick_Up_Contact = "John Smith", Delivery_Contact = "Bob White", Description = "Textbooks", Status = "In Transit", Price = 45.00m, Created_At = new DateTime(2023, 09, 02), Scheduled_At = new DateTime(2023, 9, 4), Completed_On = new DateTime(2023, 9, 5), CustomerId = 4 },
                new OrderPlacement {Id = 15, Pick_Up_Address = "100 Book St", Delivery_Up_Address = "130 Library Lane", Pick_Up_Contact = "John Smith", Delivery_Contact = "Charlie Black", Description = "Novels", Status = "Pending", Price = 50.00m, Created_At = new DateTime(2023, 09, 03), Scheduled_At = new DateTime(2023, 9, 6), Completed_On = new DateTime(2023, 9, 7), CustomerId = 4 },
                new OrderPlacement {Id = 16, Pick_Up_Address = "100 Book St", Delivery_Up_Address = "140 Library Lane", Pick_Up_Contact = "John Smith", Delivery_Contact = "David Green", Description = "Magazines", Status = "Cancelled", Price = 30.00m, Created_At = new DateTime(2023, 09, 04), Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 4 },

                // Orders for Customer 5
                new OrderPlacement {Id = 17, Pick_Up_Address = "150 Home St", Delivery_Up_Address = "160 Home Lane", Pick_Up_Contact = "Emily White", Delivery_Contact = "James Black", Description = "Home Goods", Status = "Delivered", Price = 200.00m, Created_At = new DateTime(2023, 09, 01), Scheduled_At = new DateTime(2023, 9, 2), Completed_On = new DateTime(2023, 9, 3), CustomerId = 5 },
                new OrderPlacement {Id = 18, Pick_Up_Address = "150 Home St", Delivery_Up_Address = "170 Home Lane", Pick_Up_Contact = "Emily White", Delivery_Contact = "Sarah Green", Description = "Furniture", Status = "In Transit", Price = 800.00m, Created_At = new DateTime(2023, 09, 02), Scheduled_At = new DateTime(2023, 9, 4), Completed_On = new DateTime(2023, 9, 5), CustomerId = 5 },
                new OrderPlacement {Id = 19, Pick_Up_Address = "150 Home St", Delivery_Up_Address = "180 Home Lane", Pick_Up_Contact = "Emily White", Delivery_Contact = "Paul Red", Description = "Kitchenware", Status = "Pending", Price = 150.00m, Created_At = new DateTime(2023, 09, 03), Scheduled_At = new DateTime(2023, 9, 6), Completed_On = new DateTime(2023, 9, 7), CustomerId = 5 },
                new OrderPlacement {Id = 20, Pick_Up_Address = "150 Home St", Delivery_Up_Address = "190 Home Lane", Pick_Up_Contact = "Emily White", Delivery_Contact = "Jessica Blue", Description = "Decorations", Status = "Cancelled", Price = 100.00m, Created_At = new DateTime(2023, 09, 04), Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 5 },

                // Orders for Customer 6
                new OrderPlacement {Id = 21, Pick_Up_Address = "200 Fitness St", Delivery_Up_Address = "210 Gym Lane", Pick_Up_Contact = "Mike Brown", Delivery_Contact = "Anna Green", Description = "Gym Equipment", Status = "Delivered", Price = 500.00m, Created_At = new DateTime(2023, 09, 01), Scheduled_At = new DateTime(2023, 9, 2), Completed_On = new DateTime(2023, 9, 3), CustomerId = 6 },
                new OrderPlacement {Id = 22, Pick_Up_Address = "200 Fitness St", Delivery_Up_Address = "220 Gym Lane", Pick_Up_Contact = "Mike Brown", Delivery_Contact = "Laura Black", Description = "Fitness Apparel", Status = "In Transit", Price = 150.00m, Created_At = new DateTime(2023, 09, 02), Scheduled_At = new DateTime(2023, 9, 4), Completed_On = new DateTime(2023, 9, 5), CustomerId = 6 },
                new OrderPlacement {Id = 23, Pick_Up_Address = "200 Fitness St", Delivery_Up_Address = "230 Gym Lane", Pick_Up_Contact = "Mike Brown", Delivery_Contact = "Cathy White", Description = "Health Supplements", Status = "Pending", Price = 300.00m, Created_At = new DateTime(2023, 09, 03), Scheduled_At = new DateTime(2023, 9, 6), Completed_On = new DateTime(2023, 9, 7), CustomerId = 6 },
                new OrderPlacement { Id = 24, Pick_Up_Address = "200 Fitness St", Delivery_Up_Address = "240 Gym Lane", Pick_Up_Contact = "Mike Brown", Delivery_Contact = "Sarah Blue", Description = "Yoga Mats", Status = "Cancelled", Price = 100.00m, Created_At = new DateTime(2023,09,04), Scheduled_At = new DateTime(2023, 9, 7), Completed_On = new DateTime(2023, 9, 8), CustomerId = 6 }
